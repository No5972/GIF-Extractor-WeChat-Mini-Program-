...
GIF = require('./gif');
console.log("simluate initialize gifuct");
global.GIF = GIF;
...
GIF.prototype.decompressFrame = function(index, buildPatch){
	...
	function lzw(minCodeSize, data, pixelCount) {
		...
		var npix = pixelCount;
		var available, clear, code_mask, code_size, end_of_information, in_code, old_code, bits, code, i, count, datum, data_size, first, top, bi, pi;
...
console.log("simulate finish initialize gifuct");
